...
One recipient creates or returns an existing [DM channel](/resources/channel#channel-object), no or multiple recipients create a [group DM channel](/resources/channel#channel-object). Returns a [private channel](/resources/channel#channel-object) object. Fires a [Channel Create](/topics/gateway-events#channel-create) Gateway event. (If a channel with the specified recipient already exists the channel with the largest ID will be returned)
